/**
 * resources/examples/35-methods/server-method.mjs — Server with a Multiply method
 */
import { OPCUAServer, Variant, DataType, StatusCodes } from "node-opcua";

const server = new OPCUAServer({
  port: 4335,
  resourcePath: "/UA/MethodDemo"
});
...
await server.start();
console.log("Method server:", server.getEndpointUrl());

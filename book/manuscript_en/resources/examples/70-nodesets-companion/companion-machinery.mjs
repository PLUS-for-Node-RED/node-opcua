 ...
 * Teaching goal: load DI + IA + Machinery, subtype a Device, attach an Identification AddIn
 *
 * Source/model: packages/node-opcua-samples/bin/machineryServer.js
...
// File it under the Machines folder (Machinery entry point)
...
console.log("Browse: Objects -> DeviceSet / Machines -> DemoMachine-1");
console.log("Specs: see https://reference.opcfoundation.org/");

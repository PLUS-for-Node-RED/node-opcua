/**
 * resources/examples/32-miniserver/miniserver.mjs — Minimaler OPC-UA-Server (Node.js 24)
...
const server = new OPCUAServer({
  port: 4334,
  resourcePath: "/UA/Lernpfad",
  buildInfo: {
    productName: "LernpfadMiniServer",
    buildNumber: "1",
    buildDate: new Date()
  }
});
...
await server.start();
console.log("Server läuft:", server.getEndpointUrl());
